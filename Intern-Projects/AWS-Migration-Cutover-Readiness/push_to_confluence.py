...
Uploads AWS-Migration-Cutover-Readiness.html to the
"Intern Project — AWS Migration Cutover Readiness (DRAFT)" Confluence page
and attaches diagram PNGs from design-images/.

Target page: https://veradigm.atlassian.net/wiki/spaces/LSE/pages/6763118607
...
HTML_FILE  = SCRIPT_DIR / "AWS-Migration-Cutover-Readiness.html"
